<!-- //$tampil = "SELECT k.id, k.code, k.name, (SELECT COUNT(*) FROM pendukung3 as p WHERE p.kabupaten=k.code) as jumlah -->


<!-- <canvas id="myChart" class="col-12 col-sm-12" style="height: 250px;"></canvas> -->
<?php
$tampil = "SELECT k.id, k.name, k.stat, (SELECT COUNT(*) FROM pendukung3 as p WHERE p.kabupaten=k.code) as jumlah, koordinator.*, p.*, k.code as code
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="table-responsive">
                ...
                <a href="<?= $base_url; ?>?r=infografis" class="btn btn-outline-primary" style="float:left;margin-bottom:1%;">
                    ...
                    ?>
                        <tr id="<?= $row['code'] ?>">
                            ...
                            <td>
                                ...
                                if ($row['stat'] == 'Disable') {
                                ?>
                                    <a href="app/infografis/enable.php?code=<?php echo $row['code'] ?>" class="btn btn-primary" onclick="return confirm('Munculkan <?php echo $nama ?>?')">
                                ...
                                ?>
                                    <a href="app/infografis/disable.php?code=<?php echo $row['code'] ?>" class="btn btn-danger" onclick="return confirm('Sembunyikan <?php echo $nama ?>?')">
